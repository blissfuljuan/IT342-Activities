...
import com.cabido.oauth2login.service.GooglePeopleService;
...
public class WebController {
    ...
    private final com.cabido.oauth2login.service.GooglePeopleService googlePeopleService;

    public WebController(GooglePeopleService googlePeopleService) {
        this.googlePeopleService = (com.cabido.oauth2login.service.GooglePeopleService) googlePeopleService;
    }
