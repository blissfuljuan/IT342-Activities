package com.cervantes.midterm.Controller;

import com.cervantes.midterm.Services.GoogleContactsServices;
...
public class ContactsController {
    ...
    private final GoogleContactsServices contactsService;
    private final OAuth2AuthorizedClientService authorizedClientService;

    public ContactsController(GoogleContactsServices contactsService, OAuth2AuthorizedClientService authorizedClientService) {
